...
class G3MiniResult:
    ...
    def _normalize_info_hash(self, value) -> str:
        ...
        if len(info_hash) == 40 and all(c in "0123456789abcdef" for c in info_hash):
            return info_hash
        # Handle hex-encoded 80-char variant (same as GenerationFree)
    ...
    def from_api_item(self, api_item: dict, media) -> "G3MiniResult":
        ...
        base_url = (settings.g3mini_url or "https://gemini-tracker.org").rstrip("/")
        self.magnet = (
